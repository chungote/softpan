...
this.Control[iCurrent+1]=this.cbx_logfile
this.Control[iCurrent+2]=this.cb_del
this.Control[iCurrent+3]=this.cb_addfile
...
this.Control[iCurrent+8]=this.sle_send_email
this.Control[iCurrent+9]=this.st_4
this.Control[iCurrent+10]=this.st_3
this.Control[iCurrent+11]=this.sle_from_email
this.Control[iCurrent+12]=this.sle_from_name
this.Control[iCurrent+13]=this.cbx_receipt
...
// *** send the message *************************
ls_encrypt = of_getreg("SmtpEncrypt", "None")
